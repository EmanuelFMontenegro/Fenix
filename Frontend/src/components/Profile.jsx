  ...
  return (
    <div className="container"> 
      <div className="profile-selector"> 
        ...
        <button className='boton1' onClick={() => changeProfile(1)}>Perfil 1 (Administrador)</button>
        <button className='boton2' onClick={() => changeProfile(2)}>Perfil 2 (Otro rol)</button>
        <button className='boton3' onClick={() => changeProfile(3)}>Perfil 3 (Otro rol)</button>
      </div>
    </div>
  );
};
